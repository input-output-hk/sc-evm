...
object PairingCheck {
  ...
  final case class Precomputed(g2: Point[Fp2], coeffs: EllCoeffs)
  final case class EllCoeffs(ell0: Fp2, ellW: Fp2, ellV: Fp2)
  final case class G1G2Pair(a: BN128G1, b: BN128G2)
}
