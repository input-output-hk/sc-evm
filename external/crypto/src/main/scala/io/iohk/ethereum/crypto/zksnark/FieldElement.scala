...
final case class Fp(inner: BigInt) extends FieldElement
...
final case class Fp2(a: Fp, b: Fp) extends FieldElement
...
final case class Fp6(a: Fp2, b: Fp2, c: Fp2) extends FieldElement
...
final case class Fp12(a: Fp6, b: Fp6) extends FieldElement
