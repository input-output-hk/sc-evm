{pkgs}: let
  ...
  cryptopp_5_6_5 =
    (cryptopp.overrideAttrs (_: rec {
      ...
      installTargets = "";
      # libtool is missing when building on macos
...
in
  stdenv.mkDerivation {
    pname = "retesteth";
    version = "v0.2.2-testinfo";

    src = fetchFromGitHub {
      owner = "input-output-hk";
      repo = "retesteth";
      rev = "0.2.2-no-hunter";
      sha256 = "sha256-EyQzou832BlxudYErqePUZfboCNhmvpiwksKg3ghjgU=";
    };
    ...
    meta.description = "testeth via RPC. Test run, generation by t8ntool protocol";
  }
