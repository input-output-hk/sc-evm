...
// TODO needs migration to new domain classes
// import akka.actor._
// import akka.testkit.{TestActorRef, TestKit, TestProbe}
// import io.iohk.bytes.ByteString
// import com.miguno.akka.testing.VirtualTime
// import io.iohk.scevm.network.ObftPeerManagerActor.{PeerInfo, RemoteStatus}
// import io.iohk.scevm.network.PeerActor.{ConnectTo, PeerClosedConnection}
// import io.iohk.scevm.network.PeerEvent.PeerDisconnected
// import io.iohk.scevm.network.PeerEventBusActor.SubscriptionClassifier.PeerHandshaked
// import io.iohk.scevm.network.PeerEventBusActor.{PeerEvent, Publish, Subscribe}
// import io.iohk.scevm.network.PeerManagerActor.{GetPeers, Peers, SendMessage}
// import io.iohk.scevm.network.discovery.{DiscoveryConfig, Node, PeerDiscoveryManager}
// import io.iohk.scevm.network.p2p.messages.PV100.NewBlock
...
// import io.iohk.scevm.testing.tags.NeedsMigration
// import io.iohk.scevm.config._
// import io.iohk.scevm.testing.NormalPatience
// import io.iohk.scevm.testing.WithActorSystemShutDown
...
//   it should "handle common message about sending message to peer" taggedAs NeedsMigration in new TestSetup {
//     start()
//     handleInitialNodesDiscovery()
...
//     baseBlockHeader.copy(number = initialPeerInfo.maxBlockNumber + 4)
//     val block = NewBlock(???)
